...
describe('QuizManagerService', () => {
    ...
    it('should return true if quiz form is valid and the amount of choices of a question has been modified (when newQuiz.id is not empty)', () => {
        ...
        const modifiedChoiceIndex = modifiedQuestions[0].choices as Choice[];
        modifiedQuestions[0] = {
            ...modifiedQuestions[0],
            choices: [...modifiedChoiceIndex, { text: 'Choice 3', isCorrect: true }],
        };
    ...
    it('should return true if quiz form is valid and the information of a question choice was modified (when newQuiz.id is not empty)', () => {
        ...
        if (modifiedQuestions[modifiedQuestionIndex].choices) {
            const modifiedChoices = modifiedQuestions[modifiedQuestionIndex].choices.slice(1);
            const modifiedChoiceIndex = 0;
            if (modifiedChoices[modifiedChoiceIndex]) {
                modifiedChoices[modifiedChoiceIndex] = {
                    ...modifiedChoices[modifiedChoiceIndex],
                    text: 'Modified Choice 1',
                };
            }
            modifiedQuestions[modifiedQuestionIndex] = {
                ...modifiedQuestions[modifiedQuestionIndex],
