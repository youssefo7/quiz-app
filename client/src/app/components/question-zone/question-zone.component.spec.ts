...
// We have a mock quizzes that take a lot of lines and we don't want to put them in a separate file
...
describe('QuestionZoneComponent', () => {
    ...
    it('should fetch the quiz and the first question', fakeAsync(() => {
        const getQuizSpy = spyOn<any>(component, 'getQuiz');
    ...
    it('should show results', () => {
        ...
        spyOn<any>(component, 'givePoints');
