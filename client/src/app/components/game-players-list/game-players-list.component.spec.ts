...
describe('GamePlayersListComponent', () => {
    ...
    it('should update player status when abandonedGame event is received and sort the players in the correct order', () => {
    ...
    it("should call resetPlayersInfo() when transition clock has finished, sort and update the player's status", async () => {
        component['isSortedByState'] = true;
        component['shouldSortStatesAscending'] = true;
