...
describe('CountdownComponent', () => {
    ...
    it('should react to TimerFinished event and start next question when the transition timer has ended', () => {
        const roomId = '123';
        component['hasFinishedTransitionClock'] = true;
        component['roomId'] = roomId;
        component['isHost'] = true;
    ...
    it('should prepare the transition clock for the next question on NextQuestion event', () => {
