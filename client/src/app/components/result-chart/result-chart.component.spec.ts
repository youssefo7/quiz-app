...
describe('ResultChartComponent', () => {
    ...
    it('should increment the currentQuestionIndex and call updateChartToLoad when transitionning to the next question', () => {
        ...
        expect(component.currentQuestionIndex).toEqual(component['lastQuestionIndex']);
    ...
    it('should verify if it is possible for a user to go to alternate between charts', () => {
    ...
    it('should check if player can go to the next or previous question when handleNavigation is called', () => {
    ...
    it('should not let player can go to previous question when handleNavigation is called and the user is at the first question', () => {
        component.canGoToNextQuestion = false;
        component.canGoToPreviousQuestion = false;
    ...
    it('should update chart data to load', fakeAsync(() => {
        component.roomId = '1234';
        component['chartData'] = mockQuestionsChartData;
        component.currentQuestionIndex = 0;
