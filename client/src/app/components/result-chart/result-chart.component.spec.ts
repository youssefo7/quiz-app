...
describe('ResultChartComponent', () => {
    ...
    it('should not let player go to previous question when updateQuestionNavigation is called and the user is at the first question', () => {
        component.canGoToNextQuestion = false;
        component.canGoToPreviousQuestion = false;
    ...
    it('should update chartDataToLoad', fakeAsync(() => {
        component['chartData'] = mockQuestionsChartData;
        component.currentQuestionIndex = 0;
