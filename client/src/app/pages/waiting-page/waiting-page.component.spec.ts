...
describe('WaitingPageComponent', () => {
    ...
    it('should connect and handle any users actions if the socket does not exists and is a host', async () => {
    ...
    it('should connect and handle any user actions if the socket does not exists and is not a host', async () => {
        clientSocketServiceMock.socketExists.and.returnValue(false);
        clientSocketServiceMock.connect.and.callThrough();
